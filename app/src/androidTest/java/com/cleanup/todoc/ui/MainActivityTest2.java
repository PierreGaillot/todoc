...
public class MainActivityTest2 {
    ...
    public void mainActivityTest2() {
        ...
        appCompatEditText.perform(replaceText("tache test"), closeSoftKeyboard());
        appCompatButton.perform(scrollTo(), click());

        ViewInteraction textView = onView(withId(R.id.lbl_task_name));
        textView.check(matches(withText("tache test")));
    }
